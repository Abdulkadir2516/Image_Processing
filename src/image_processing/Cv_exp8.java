...
public class Cv_exp8 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(start)
                .addGap(36, 36, 36)
                .addComponent(pencere, javax.swing.GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void camOpen() {
        ...
        VideoCapture videoCapture = new VideoCapture("http://192.168.1.104:34568/mjpeg.cgi");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cv_exp8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
